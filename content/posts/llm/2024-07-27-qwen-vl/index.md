...
- llm
- lvlm
url: "/posts/llm/2024-07-27-qwen-vl/"
showToc: true
draft: false
---
...
The data in pre-train process consists of 1.4 billion images, 77.3% in English and 22.7 in Chinese, where in finetuning process consists of 350k instruction data. The training part consists of three processes, shown below:

![Training Processes](training_process.png)
...
![Hyper-parameters](hyper-params.png)
