...
- lvlm
- gui-agent
url: "/posts/others/2024-08-20-seeclick/seeclick.html"
showToc: true
draft: false
---
...
1. GUI-Grouding : Use many GUI datasets[^1] to improve model understanding in the world of widgets such as [RICO](http://www.interactionmining.org/rico.html)
...
Due to limited resources, I only able to train the GUI-Grouding stage with only one small dataset[^2] on 4 RX4090 GPUs with 24GB RAM each. Using q-LORA for the fine-tuning stage, it takes about 2.5 hours. Below is the training configuration :
...
[^1]: Training used one million examples spanning 30 tasks.
[^2]: RICO widget-captioning data.
